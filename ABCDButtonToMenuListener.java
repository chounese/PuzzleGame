...
public class ABCDButtonToMenuListener implements ActionListener {

	private JButton myButton;
	JPopupMenu  menu;
	
	public ABCDButtonToMenuListener(JButton clicker, Game game,  int i, int j) {
		myButton = clicker;
		...
		JMenuItem five = new JMenuItem("Blank");
		menu.add(five);
